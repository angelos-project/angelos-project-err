...
kotlin {
    ...
    nativeTarget.apply {
        val includePath = file("${project(":c-error").projectDir}/src/main/public/").absolutePath
        val libraryPathMain = file(project.file("${project(":c-error").buildDir}/lib/main/release/")).absolutePath
        val libraryPathTest = file(project.file("${project(":c-error").buildDir}/lib/main/debug/")).absolutePath
