...
object MetaProject {
     ...
     */
    const val group = "org.angproj.io.err"
     ...
     */
    const val mavenName = "POSIX Error Handling"

    /**
     * Long description for MavenCentral.
     */
    const val mavenDescription = "The error handling in POSIX for low level functions. Gets errno and errmsg."
